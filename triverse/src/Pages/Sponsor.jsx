...
const Sponsor = () => {
  return (
    <div className='h-full w-screen bg-black text-center '>
      ...
      <div className="md:text-5xl text-4xl mt-6">
        Call for Sponsors
      </div>
     

    <div className=' mt-4 md:my-14 bg-grey-900 flex justify-center items-center ms-1  md:ms-4' id='sponsorship-tiers'>
     
       <div className='flex my-10 gap-6 flex-wrap '>
   ...
   <h2 className='md:text-6xl text-5xl mb-8'>Whats in it for you?</h2>
   <h4 className='mb-8'>Tap on the link below to view our sponsorship deck</h4>
