...
const Timeline = () => {
  ...
  <li className=''>
    ...
    <div className=" timeline-end mb-10 rounded-xl ">
      <time className="font-mono italic">Influencer</time>
 ...
 Venue: 002 ALH    </div>
  ...
  <li className='mb-6  '>
    ...
    <div className=" timeline-start md:text-end mb-10 p-2 rounded-xl ">
      ...
      <div className="text-lg font-black ">4th April || 6:30 to 11:00</div>
Venue: 102 BLH + 103 BLA   </div>
    <hr className='bg-yellow-400'/>
  </li>
  <li className='mb-6'>
    <hr className='bg-yellow-400'/>
    ...
    <div className=" timeline-end mb-10 rounded-xl   ">
      ...
      <div className="text-lg font-black">5th April || 6:30 to 11:00 Pm</div>
Venue: Hexagonal room + 301 ALH</div>
    <hr className='bg-yellow-400'/>
  </li>
  <li className='mb-6  '>
    <hr className='bg-yellow-400'/>
...
A cyber security event where uhouhouho   </div>
  ...
  <li className='mb-6  '>
    ...
    <div className=" timeline-end md:text-end mb-10 p-2 rounded-xl ">
      <time className="font-mono italic">Unlocking tommorow</time>
      <div className="text-lg font-black ">6th April || 10AM - 3PM</div>
Venue: 101 ALH </div>
    <hr className='bg-yellow-400'/>
  </li>
  <li className='mb-6'>
    ...
    <div className=" timeline-start mb-10 rounded-xl   ">
      <time className="font-mono italic">Code Roast</time>
      <div className="text-lg font-black">6th April  || 6PM to 11PM</div>
Venue: 102 BLH + 103BLA</div>
    <hr className='bg-yellow-400'/>
  </li>
  <li className='mb-6'>
    <hr className='bg-yellow-400'/>
    ...
    <div className=" timeline-end md:text-end mb-10 rounded-xl  p-2 ">
      <time className="font-mono italic">Hackacinno</time>
      <div className="text-lg font-black">6th april 10Pm to 7th april 10pm</div>
      Venue: P-block
    </div>
  </li>
